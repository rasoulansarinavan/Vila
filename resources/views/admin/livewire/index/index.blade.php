<section class="content-main">
    <div class="content-header">
        ...
        <div><a class="btn btn-primary" href="#"><i class="text-muted material-icons md-post_add"></i>Create report</a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-3">
                        ...
                        <article class="card-body">
                            ...
                            <div class="new-member-list">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <a class="btn btn-xs" href="#"><i class="material-icons md-add"></i> Add</a>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center"><img class="avatar"
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center"><img class="avatar"
                                                                                src="assets/imgs/people/avatar3.jpg"
                                                                                alt="">
                                        <div>
                                            <h6>Tomas Baker</h6>
                                            <p class="text-muted font-xs">Sanfrancisco</p>
