    ...
    <div class="card mx-auto card-login">
        <div class="card-body">
            ...
            <form>
                ...
                <div class="mb-3">
                    <p class="small text-center text-muted"></p>By signing up, you confirm that you&rsquo;ve read and accepted our User Notice and Privacy Policy.
                </div>
                <div class="mb-4">
                ...
                <div class="d-flex gap-2 mb-4"><a class="w-50 btn btn-light font-sm" href="#">
                        <svg class="icon-svg" aria-hidden="true" style="vertical-align: bottom; margin-top:-4px;" width="20" height="20" viewbox="0 0 20 20">
                ...
                <p class="text-center mb-2">Already have an account?<a href="page-account-login.html"> Sign in now</a></p>
            </form>
        </div>
    </div>
</section>
